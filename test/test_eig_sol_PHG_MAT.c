...
int TestEigenSolver(void *A, void *B, int argc, char *argv[], struct OPS_ *ops) 
{
	...
	//int    nevMax = 50, multiMax = 20, block_size = 10;
	//int    nevMax = 5000, multiMax = 500, block_size = 200;
	int    nevMax = 10000, multiMax = 400, block_size = 200;
	//int    nevMax = 500, multiMax = 100, block_size = 50;
	//int    nevMax = 8000, multiMax = 400, block_size = 200;
...
#endif
	int    nevInc, max_iter_gcg = 5000;
	double tol_gcg[2] = {1e-2,1e-8};
...
#else	
	ops->Printf("EigenSolverDestroyWorkspace_GCG\n");
