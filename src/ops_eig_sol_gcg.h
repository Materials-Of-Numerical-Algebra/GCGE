...
typedef struct GCGSolver_ {
	...
	const char *initX_orth_method; int initX_orth_block_size; 
	int  initX_orth_max_reorth; double initX_orth_zero_tol;
	const char *compP_orth_method; int compP_orth_block_size; 
	int  compP_orth_max_reorth; double compP_orth_zero_tol;
	const char *compW_orth_method; int compW_orth_block_size; 
